        ...
        public static void InitializeNavi(TemplateDbContext context)
        {
            ...
            context.Navi.AddRange(
                new Nave
                {
                    ...
                    Arrivo = new DateTime(2024, 01, 26, 6, 0, 0),
                    Partenza = new DateTime(2024, 01, 28, 6, 0, 0),
                    Container = 3,
                    Bancali = 12
                },
                new Nave
                {
                    ...
                    Arrivo = new DateTime(2024, 03, 10, 18, 0, 0),
                    Partenza = new DateTime(2024, 03, 12, 0, 0, 0),
                    Container = 8,
                    Bancali = 2
                },
                new Nave
                {
                    ...
                    Nome = "Totano",
                    NomeCliente = "Baltic",
                    Arrivo = new DateTime(2024, 03, 12, 0, 0, 0),
                    Partenza = new DateTime(2024, 03, 19, 12, 0, 0),
                    Container = 4,
                    Bancali = 9
                },
                new Nave
                {
                    ...
                    Nome = "Orione",
                    NomeCliente = "Vismara",
                    Arrivo = new DateTime(2024, 04, 04, 6, 0, 0),
                    Partenza = new DateTime(2024, 04, 11, 14, 0, 0),
                    Container = 6,
                    Bancali = 18
                },
                new Nave
                ...
                new Nave
                {
                    ...
                    NomeCliente = "Aniston",
                    Arrivo = new DateTime(2024, 01, 12, 0, 0, 0),
                    Partenza = new DateTime(2024, 01, 18, 0, 0, 0),
                    Container = 0,
                    Bancali = 35
                });
